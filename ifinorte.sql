...
--
-- Estructura de tabla para la tabla `doc_form`
--

CREATE TABLE IF NOT EXISTS `doc_form` (
`id_doc_form` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `doc_mv`
--

CREATE TABLE IF NOT EXISTS `doc_mv` (
`id_doc_mv` int(11) NOT NULL,
  `tit_mv` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `mv_id` int(11) NOT NULL,
  `submv_id` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `men_vert`
--
...
`id_nt` int(11) NOT NULL,
  ...
  `txt_nt` text COLLATE utf8_spanish_ci NOT NULL,
  `fe_nt` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
`id_prov` int(11) NOT NULL,
  `nam_prov` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `rut_prov` varchar(455) COLLATE utf8_spanish_ci NOT NULL,
  `lk_prov` varchar(455) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Estructura de tabla para la tabla `sub_form`
--
...
--
-- Estructura de tabla para la tabla `sub_mv`
--

CREATE TABLE IF NOT EXISTS `sub_mv` (
...
ALTER TABLE `doc_form`
 ADD PRIMARY KEY (`id_doc_form`), ADD KEY `form_id` (`form_id`,`sub_id`), ADD KEY `sub_id` (`sub_id`);

--
-- Indices de la tabla `doc_mv`
--
ALTER TABLE `doc_mv`
 ADD PRIMARY KEY (`id_doc_mv`), ADD KEY `mv_id` (`mv_id`,`submv_id`), ADD KEY `submv_id` (`submv_id`);
...
ALTER TABLE `img_galeria`
 ADD PRIMARY KEY (`id_img_gal`), ADD KEY `gal_id` (`gal_id`);

--
-- Indices de la tabla `men_vert`
--
...
--
-- Indices de la tabla `sub_form`
--
ALTER TABLE `sub_form`
 ADD PRIMARY KEY (`id_subf`), ADD KEY `form_id` (`form_id`);

--
-- Indices de la tabla `sub_mv`
--
ALTER TABLE `sub_mv`
...
--
ALTER TABLE `doc_form`
ADD CONSTRAINT `doc_form_ibfk_1` FOREIGN KEY (`form_id`) REFERENCES `formatos` (`id_form`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `doc_form_ibfk_2` FOREIGN KEY (`sub_id`) REFERENCES `sub_form` (`id_subf`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `doc_mv`
--
ALTER TABLE `doc_mv`
ADD CONSTRAINT `doc_mv_ibfk_1` FOREIGN KEY (`mv_id`) REFERENCES `men_vert` (`id_mv`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `doc_mv_ibfk_2` FOREIGN KEY (`submv_id`) REFERENCES `sub_mv` (`id_submv`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `sub_form`
ADD CONSTRAINT `sub_form_ibfk_1` FOREIGN KEY (`form_id`) REFERENCES `formatos` (`id_form`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `sub_mv`
--
ALTER TABLE `sub_mv`
ADD CONSTRAINT `sub_mv_ibfk_1` FOREIGN KEY (`mv_id`) REFERENCES `men_vert` (`id_mv`) ON DELETE CASCADE ON UPDATE CASCADE;
