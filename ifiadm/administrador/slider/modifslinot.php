<?php
	...
	if (isset($_SESSION['adm'])) {
		...
		if ($idR=="") {
			...
			$datos="SELECT * from galeria where id_gal=$idR";
...
<head>
	...
	<meta name="description" content="Modificar <?php echo $ttSn ?>" />
...
<body>
	...
	<nav id="mnad">
		<a href="../slider">Ver Sliders noticias</a>
		<a href="slider_images.php">Slider de imágenes</a>
	</nav>
	<section>
		<h1><?php echo "$ttSn"; ?></h1>
		<article id="automargen">
			<form action="modif_slidnoticia.php" method="post" class="columninput">
				<input type="text" name="idSn" value="<?php echo $idR ?>" required style="display:none;" />
				<label>*<b>Titulo</b></label>
				<input type="text" name="ttsln" value="<?php echo $ttSn ?>" required />
				<label><b>Frase</b></label>
				<input type="text" name="frsln" value="<?php echo $frSn ?>" />
				<label>*<b>Texto</b></label>
				<textarea id="editor1" name="txtsln"><?php echo "$txSn"; ?></textarea>
...
<?php
				...
				echo "<script type='text/javascript'>";
					echo "alert('Slider noticia no eiste o eliminada');";
					echo "var pagina='../slider';";
					echo "document.location.href=pagina;";
				echo "</script>";
			}
