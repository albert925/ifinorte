	...
	<section>
		...
		<article id="automargen">
			<form action="#" method="post" class="columninput">
				<label>*<b>Nuevo tipo de perfil</b></label>
				<input type="text" id="ptdc" name="ptdc" required />
				<div id="txA"></div>
				<input type="submit" value="Ingresar" id="nvtpdc" />
			</form>
		</article>
		<br />
		<article id="automargen" class="flB">
			<?php
				...
				$ssql="SELECT * from tp_dic order by id_tpdc desc";
				$rs=mysql_query($ssql,$conexion) or die (mysql_error());
				$num_total_registros= mysql_num_rows($rs);
				$total_paginas= ceil($num_total_registros / $tamno_pagina);
				$gsql="SELECT * from tp_dic order by id_tpdc desc limit $inicio, $tamno_pagina";
			...
			<article class="columninput">
				<input type="text" id="titmn_<?php echo $iddc ?>" value="<?php echo $nmdc ?>" />
				<div id="txB_<?php echo $iddc ?>"></div>
				<input type="submit" value="Modificar" class="ccpp" data-id="<?php echo $iddc ?>" />
				<a class="doll" href="borr_tipoperfil.php?br=<?php echo $iddc ?>">Borrar</a>
			</article>
			<?php
				}
			?>
		...
		<article id="automargen">
			...
			<?php
				...
				?>
							<a href="tipo_perfil.php?pagina=<?php echo $i ?>"><?php echo "$i"; ?></a>
