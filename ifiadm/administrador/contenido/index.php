...
<head>
	...
	<meta name="description" content="Administrar contenidos principal" />
	<meta name="keywords" content="Finacioero, prestacion de servicios" />
	<title>admin contenido| Ifinorte</title>
...
<body>
	...
	<section>
		<h1>Contenidos</h1>
		<article id="automargen" class="flB condiv">
			<div>
				<a href="../contenido/menus.php">Menu Vertical</a>
			</div>
			<div>
				<a href="../contenido/submenus.php">Submenu Vertical</a>
			</div>
			<div>
				<a href="../conmenv">Contenido menus vertical</a>
			</div>
			<div>
				<a href="../boletin">Boletin Informativo</a>
			</div>
			<div>
