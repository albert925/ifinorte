<?php
	...
	if ($idR=="") {
		...
		$datos="SELECT * from mn_porf where id_mn_po=$idR";
...
<head>
	...
	<meta name="description" content="Portafolio <?php echo $nmmnPF ?> de ifinorte" />
	<meta name="keywords" content="Financiero, prestacion de servicios" />
	<title>Portafolio <?php echo "$nmmnPF"; ?>|Ifinorte</title>
...
<body>
	...
	<section>
		<article id="automargen" class="flmvycont">
			...
			<section>
				<h1><?php echo "$nmmnPF"; ?></h1>
				<?php
					$txporta="SELECT * from portafolio where mn_pid=$idR order by id_port desc";
...
<?php
			...
			echo "<script type='text/javascript'>";
				echo "alert('Portafolio ha sido eliminada o no existe');";
				echo "var pagina='../portafolio';";
				echo "document.location.href=pagina;";
			echo "</script>";
		}
