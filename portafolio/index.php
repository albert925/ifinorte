...
<head>
	...
	<meta name="description" content="Portafolio de ifinorte" />
	<meta name="keywords" content="Financiero, prestacion de servicios" />
	<title>Portafolio|Ifinorte</title>
			...
			<nav id="mnP">
				<ul>
					...
					<li class="submen" data-num="1">
						<a class="sell" href="../portafolio">Portafolio de servicios</a>
						<ul class="children1">
							<?php
	...
	<section>
		<article id="automargen" class="flmvycont">
			...
			<section>
				...
				<article>
					<p>
						<b>IFINORTE</b> Es el Instituto de Fomento y  Desarrollo Regional. Está comprometido con el desarrollo socio económico y cultural del departamento  Norte de Santander apoyando a los entes territoriales,  entidades públicas y privadas, a través de Créditos, Convenios, Capacitación y Asesoría en el fortalecimiento de proyectos productivos que permiten la consolidación de nuestros clientes. 
					</p>
					<h4>PORTAFOLIO DE SERVICIOS</h4>
				</article>
				<article class="columportafolio">
					<?php
						$gsql="SELECT * from mn_porf order by nam_po asc";
						$impsql=mysql_query($gsql,$conexion) or die (mysql_error());
						while ($gh=mysql_fetch_array($impsql)) {
							$idmnPF=$gh['id_mn_po'];
							$nmmnPF=$gh['nam_po'];
					?>
					<article class="menusdoctun">
						<a href="portaf.php?pf=<?php echo $idmnPF ?>"><?php echo "$nmmnPF"; ?></a>
					</article>
					<?php
						}
					?>
