...
<head>
	...
	<meta name="description" content="Contacto de ifinorte" />
	<meta name="keywords" content="Contacto,sugerencias quejas y reclamos" />
	<title>Contacto|Ifinorte</title>
		...
		<article id="mn_red">
			...
			<nav id="mnP">
				<ul>
					...
					<li><a class="sell" href="../contacto">Contáctenos</a></li>
					<?php
						if ($idus=="0") {
					?>
				...
				<article class="flxcont">
					...
					<article id="forct">
						<form action="#" method="post" class="columninput">
							<label for="nmctsj">*<b>Nombre</b></label>
							<input type="text" id="nmctsj" required />
							<label for="corctsj">*<b>Correo</b></label>
							<input type="email" id="corctsj" required />
							<label for="ausctsj">*<b>Asunto</b></label>
							<select id="ausctsj">
								<?php
									$arras=["Selecione","Quejas y Reclamos","Afiliaciones","Crédito","Información","Crédito","Soporte"];
									for ($i=0; $i <=6 ; $i++) { 
								?>
								<option value="<?php echo $i ?>"><?php echo $arras[$i]; ?></option>
								<?php
									}
								?>
							</select>
							<label>*<b>Mensaje</b></label>
							<textarea rows="3" id="msjj"></textarea>
							<div id="txjs"></div>
							<input type="submit" value="Enviar" id="nvjjcc" />
						</form>
					</article>
				</article>
			</section>
