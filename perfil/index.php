...
<body>
			...
			<nav id="mnP">
				<ul>
					...
					<li class="submen" data-num="2">
						<a class="sell" href="../perfil">Perfiles Directivos</a>
						<ul class="../children2">
							<?php
	...
	<section>
		<article id="automargen" class="flmvycont">
			...
			<section>
				<h1>Perfiles Directivos</h1>
				<article>
					<p>
						Este link se realiza con el objetivo de que los usuarios que ingresen a la página web, conozcan los perfiles del Gerente, Subgerentes y Profesionales Universitarios Especializados del Instituto Financiero para el Desarrollo de Norte de Santander IFINORTE. 
					</p>
				</article>
				<article class="columportafolio">
					<?php
						$gsql="SELECT * from tp_dic order by id_tpdc asc";
					...
					<article class="menusdoctun">
						<a href="tpperfil.php?fl=<?php echo $iddcPf ?>"><?php echo "$nmdcPf"; ?></a>
					</article>
					<?php
						}
					?>
